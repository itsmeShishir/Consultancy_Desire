    ...
    <div class=slideover id=enquiry-slide-over>
        ...
        <div class=slideover-body>
            <form action="{{ route('enquery.now') }}" method="post">
                ...
                <input type=text name="Qualification" class=form-control placeholder="+2 min" required>
                <input type=text name="ieltsscore" class=form-control placeholder="Enter your IELTS Score" required>
                <input type=text name="country" class=form-control placeholder="Enter the country name you want to go" required>
            ...
            <div class="carousel-inner">
                @foreach ($banners as $banner)
                    <div class="carousel-item {{ $banner['id']==1?'active':'' }}">
                        <div class="caption-container overlap-left slida">
                            <div class="caption-top">
                                <ul>
                                    <li>
                                        <div class="img-container" style="max-height: 150px;"> <img
        ...
        <div class="row justify-content-between">
            <div class="col-md-6 col-lg-3 col-cont">
                <div class=col-cont-main>
                    <div id="demo1" onmouseover="mouseOver()" onmouseout="mouseOut()" class="demo1 circle-img "> <img src="{{ asset('assets/images/Test-Preparation-Classes.png') }}" alt="">
                    </div>
                    <h6>Test Preparation</h6>
                </div>
            </div>
            <div class="col-md-6 col-lg-3 col-cont">
                <div class=col-cont-main>
                    <div id="demo2" onmouseover="mouseover()" onmouseout="mouseout()" class=" circle-img "> <img src="{{ asset('assets/images/education-counselor.png') }}" alt=""> </div>
                    <h6>Expert Counseling</h6>
                </div>
            </div>
            <div class="col-md-6 col-lg-3 col-cont">
                <div class=col-cont-main>
                    <div id="demo6" class="circle-img" onmouseover="mouseoveR()" onmouseout="mouseouT()"> <img src="{{ asset('assets/images/Lodge-Visa-documents.png') }}" alt="">
                    </div>
            ...
            <div class="col-md-6 col-lg-3 col-cont">
                <div class=col-cont-main>
                    <div id="demo4" onmouseover="Mouseover()" onmouseout="Mouseout()" class="circle-img"> <img src="{{ asset('assets/images/exam-2.png') }}" alt=""> </div>
                            ...
                            @foreach ($testimonials as $testy)
                                <div class="carousel-item {{ $testy['id']==1 ? 'active':'' }}">
                                    ...
                                    <div class=review-text>
                                        <p class="text-content" style="font-size: 1.4rem !important;">{!! html_entity_decode($testy->desc) !!}</p>
                            ...
                            <div class=row>
                                ...
                                <div class="col-lg-6 text-col">
                                    <div class=text-card>
                                        ...
                                        <div class=btn-row> <a class="btn btn-white" id="mybttn">Contact Us
                            ...
                            <div class=row>
                                ...
                                <div class="col-lg-6 text-col">
                                    <div class=text-card>
                                        ...
                                        <div class=btn-row> <a class="btn btn-white" id="mybttn1">Contact Us
                                                Today</a> <a href="{{ route('contact') }}" class="btn btn-white">Contact
                                                Us in
                                                Office</a> </div>
                                    </div>
                            ...
                            <div class=row>
                                ...
                                <div class="col-lg-6 text-col">
                                    <div class=text-card>
                                        ...
                                        <div class=btn-row> <a class="btn btn-white" id="mybttn2">Contact Us
                                                Today</a><a href="{{ route('contact') }}" class="btn btn-white">Contact
                                                Us in
                                                Office</a> </div>
                                    </div>
                            ...
                            <div class=row>
                                ...
                                <div class="col-lg-6 text-col">
                                    <div class=text-card>
                                        ...
                                        <div class=btn-row> <a class="btn btn-white" id="mybttn3">Contact Us
                                                Today</a> <a href="{{ route('contact') }}" class="btn btn-white">Contact
                                                Us in
                                                Office</a> </div>
                                    </div>
                ...
                @foreach ($university as $uni)
                    <div class="col-md-6 col-lg-3">
                        <a href="{{ $uni->slug }}" target="_blank">
                            <div class=img-container> <img src="{{$uni->photo}}"
                                    alt="" target="_blank">
                            </div>
                        </a>
                    </div>
