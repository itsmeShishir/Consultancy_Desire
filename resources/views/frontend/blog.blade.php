            ...
            <div class=row>
                ...
                <div class=col-md-6>
                    <a href="{{route('blog.details',$bloge->slug)}}" style="color:black;"><div class=blog-card>
                        ...
                        <div class=card-body> <span class=date-badge>{{ $bloge->created_at->format(' d M Y ') }}</span>
                            <div class=info-icon>
                                <div> <i class=ic-user></i> <span>{{ $bloge->user->name }}</span> </div>
                                <div> <i class=ic-tag></i> <span>{{ $bloge->category->name }}</span> </div>
                            </div>
