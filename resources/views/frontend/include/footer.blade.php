                ...
                <ul class="office-location">
                  ...
                  <li>
                    ...
                    <div class="tel-container">
                      <a href="tel:{{ \App\Models\Setting::value('footer_phoneone') }}">{{ \App\Models\Setting::value('footer_phoneone') }}</a>,
                      <a href="tel:{{ \App\Models\Setting::value('footer_phonetwo') }}"> {{ \App\Models\Setting::value('footer_phonetwo') }}</a>,
                      <a href="tel:{{ \App\Models\Setting::value('footer_phonethree') }}"> {{ \App\Models\Setting::value('footer_phonethree') }}</a>
                    </div>
                  </li>
                  <li>
                    <i class="ic-mail"></i>
                    <a href="mailto:{{ \App\Models\Setting::value('footer_email') }}"
                      >{{ \App\Models\Setting::value('footer_email') }}</a
                    >
                  </li>
                </ul>
              </div>
