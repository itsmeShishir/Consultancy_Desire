...
class IndexController extends Controller
{
    public function index()
    {
        ...
        $popup=Banner::where(['status'=>'active','condition'=>'popup'])->orderBy('id','DESC')->limit('3')->get();
        ...
        $houses=House::first();
        return view('frontend.index',compact('banners','university','accrediation','destinations','testimonials','popup','houses'));
    }
    ...
    public function destinationCategory(Request $request,$id){
        $data =  Destination::with('country')->find($id);
